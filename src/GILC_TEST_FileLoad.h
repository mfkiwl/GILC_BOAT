...
#define CFG_fIns2GnssVector_Y   -0.3
#define CFG_fIns2GnssVector_Z    0.8
#elif(DATA_FORM == 20180621)
#define CFG_fIns2GnssVector_X    0.5
#define CFG_fIns2GnssVector_Y    0.8
#define CFG_fIns2GnssVector_Z    0.8
#elif(DATA_FORM == 20180717)
#define CFG_fIns2GnssVector_X    0.2
#define CFG_fIns2GnssVector_Y    -1.2
#define CFG_fIns2GnssVector_Z    1.2
#else
#define CFG_fIns2GnssVector_X    0.0
